...
from functions.grb_simplifier import iteratively_remove_runs_and_bypasses
from functions.mfes import noncopy_split_to_nontrivial_sccs
from functions.utils import info_short as info
from functions.utils import double_check, to_cycle, TimeLimit
from functions.grb_pcm import get_orig_edges_map, feasible_solution, \
    initial_loop_set, missed_edges
...
def solve_problem(g_orig, stats=None, feasible_sol=None):
    ...
    for sc in noncopy_split_to_nontrivial_sccs(g2):
        print("SCC Number of Nodes: {}".format(sc.number_of_nodes()))
